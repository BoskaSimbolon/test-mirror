...
while($row = $result_chart->fetch_assoc()) {
   ...
   <script>
        ...
        /*const Patients = [
            { id: 1, first_name: "Patrick", last_name: "Mvuma", dob: "1988-05-18", phone: "999107724" },
            { id: 2, first_name: "Jane", last_name: "Smith", dob: "1990-11-22", phone: "555-987-6543" },
            { id: 3, first_name: "Robert", last_name: "Johnson", dob: "1978-03-08", phone: "555-456-7890" }
        ];*/
        ...
        document.getElementById('searchForm').addEventListener('submit', function(e) {
            ...
            // Filter patients (in real app, this would be an AJAX call to your backend)
        ...
        function displayResults(patients) {
            ...
            if (patients.length === 0) {
                ...
                patientList.appendChild(noResultsMsg);
            } else {
